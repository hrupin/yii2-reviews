...
<div class="reviews-form">
    <?php $form = ActiveForm::begin(['action' => ['/reviews/reviews/update-review'], 'options' => ['id' => 'formReviewsPjax','data-pjax' => true]]); ?>
    ...
    <?= $form->field($model, 'reviews_id')->hiddenInput()->label(false); ?>
    <?= $form->field($model, 'type')->hiddenInput()->label(false); ?>
    <?= $form->field($model, 'page')->hiddenInput()->label(false); ?>
    <?= $form->field($model, 'reviews_child')->hiddenInput()->label(false); ?>
    <?= $form->field($model, 'reviews_parent')->hiddenInput()->label(false); ?>
    <?= $form->field($model, 'user_id')->hiddenInput()->label(false); ?>
    <?= $form->field($model, 'level')->hiddenInput()->label(false); ?>
    <?= $form->field($model, 'date_create')->hiddenInput()->label(false); ?>

    <input id="hiddenURL" name="hiddenURL" type="hidden" value="<?= $url; ?>">
